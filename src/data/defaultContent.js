export const DEFAULT_SITE_CONTENT = {
  ...
  about: {
    ...
    description1: "At The Social Dev, our web development agency in India engineers tailored digital platforms and web applications customized to your business niche, target audience, and growth objectives. From modern UI/UX design to SEO-friendly web architecture, we build high-performance digital experiences that look stunning and drive real business growth.",
  ...
  whyChooseUs: {
    ...
    description1: "We do not believe in cookie-cutter website templates. As a custom web development agency in India, we engineer bespoke web solutions tailored to your unique brand, audience, and commercial goals. From responsive front-end design to robust back-end architecture, we focus on every technical detail.",
