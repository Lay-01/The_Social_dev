            ...
            <div className="hero-contant-wrapper">
              <div className="hero-top-block">
                <div className="hero-caption-block" style={{ opacity: 1 }}>
                  <img src="https://cdn.prod.website-files.com/67b6c656b6f9f2332b70fbdf/67b6d7c210598e4a1faf8511_logo-01.svg" loading="lazy" alt="The Social Dev Creative Web Development & Digital Agency Icon" className="icon-20px" />
